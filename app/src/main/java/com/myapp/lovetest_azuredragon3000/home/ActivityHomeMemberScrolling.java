...
import com.myapp.lovetest_azuredragon3000.common.BillingUltiti;
...
import com.myapp.lovetest_azuredragon3000.databinding.ContentScrollingMemberBinding;
...
import com.myapp.lovetest_azuredragon3000.databinding.ActivityScrollingHomeMemberBinding;
import com.myapp.lovetest_azuredragon3000.listener.InterfaceAds;
import com.myapp.lovetest_azuredragon3000.listener.InterfaceGetCoin;
...
public class ActivityHomeMemberScrolling extends AppCompatActivity implements InterfaceGetCoin, InterfaceAds {

    private ActivityScrollingHomeMemberBinding binding;
    //private ContentScrollingMemberBinding binding2;
    /* private */
    FirebaseUtiti firebaseUtiti;
    BillingUltiti billingUltiti;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityScrollingHomeMemberBinding.inflate(getLayoutInflater());
        setContentView(binding.getRoot());
        Toolbar toolbar = binding.toolbar;
        setSupportActionBar(toolbar);
        CollapsingToolbarLayout toolBarLayout = binding.toolbarLayout;
        toolBarLayout.setTitle(getTitle());
        userApp = (UserApp) getIntent().getSerializableExtra("KEY_NAME");
        settingDB();
        // setting ads
        settingAds();
    ...
    /* inform update new version for app */
    private void settingInformUpdate() {
        updateManager = new UpdateManager(this);
    }

    private void settingBilling() {
        billingUltiti = new BillingUltiti(this,this);
    }
    ...
    private void settingUI() {
        ...
        binding.extendlayout.logoSangold.setOnClickListener(v -> {
            firebaseUtiti.updateDB("sangold",Constant.APPNAME);
